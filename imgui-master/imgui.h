...
namespace ImGui
{
    ...
    IMGUI_API ImVec2        CalcTextSize(const char* text, const char* text_end = NULL, bool hide_text_after_double_hash = false, float wrap_width = -1.0f, float font_Size = 0.0f );
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddText(const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL, ImFont* im_font = NULL, float font_size = 0.0f);
